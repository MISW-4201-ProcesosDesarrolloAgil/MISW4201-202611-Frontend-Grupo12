...
@Component({
  ...
  styleUrls: ['./egreso-lista.component.css']
})
export class EgresoListaComponent implements OnInit {
  ...
  cargarEgresos() {
    ...
    this.ingresoEgresoService.obtenerEgresos(this.idPropiedad, mes, anio)
      .subscribe(
